...
public class UserProjSettingDao extends DaoSupport<UserProjSettingPO> {
    ...
    private UserInfoPO getCurrentUser() {
        ...
        if (currentSetting != null && currentSetting.getLinkUsrName() != null) {
            return userInfoDao.queryByUsername(currentSetting.getLinkUsrName());
        }
        return null;
    }
    ...
    public boolean isProjectSettingExists(String groupName, String projectName, String appName, String userId, String username) {
        ...
        try {
            Integer count = jdbcTemplate.queryForObject(sql, Integer.class, groupName, projectName, appName, userId, username);
