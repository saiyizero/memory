...
public class DataMigrationService {
    ...
    public CrResult<String> migrateWithProgress(DbConnectionPO source, DbConnectionPO target, List<String> tableList, 
        ...
        if (source == null || target == null || tableList == null || tableList.isEmpty()) {
            result.setSuccessFailure(SuccessFailureEnum.FAILURE);
        ...
        try {
            ...
            for (int i = 0; i < tableList.size(); i++) {
                ...
                try {
                    ...
                    // 获取表结构信息
                    DataBaseHandler inputDataBaseHandler = getInputDataBaseHandler(sourceConfig);
    ...
    private DataBaseHandler getInputDataBaseHandler(DbConfig dbConfig) {
